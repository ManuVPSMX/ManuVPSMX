...
post_reboot() {
  echo 'wget -O /root/install.sh "https://raw.githubusercontent.com/ManuVPSMX/ManuVPSMX/main/manu.sh"; clear; sleep 2; chmod +x /root/install.sh; /root/install.sh --continue' >>/root/.bashrc
...
install_ChumoGH() {
  ...
  msg -bar
  echo -e "\e[1;92m             >> INSTALACION COMPLETADA <<" && msg bar2
  echo -e "      COMANDO PRINCIPAL PARA ENTRAR AL PANEL MANUDIAZ"
  echo -e "                      \033[1;41m  menu  \033[0;37m" && msg -bar2
}
...
echo -ne " \e[1;93m [\e[1;32m2\e[1;93m]\033[1;31m > \033[1;97m INSTALAR 8.6x MODManu \e[97m \n"
echo -ne " \e[1;93m [\e[1;32m3\e[1;93m]\033[1;31m > \033[1;97m INSTALAR ADMRufu MODManu \e[97m \n"
echo -ne " \e[1;93m [\e[1;32m4\e[1;93m]\033[1;31m > \033[1;97m INSTALAR ChumoGH MODManu \e[97m \n"
